<template>
  <div id="app">
            ...
            <div class="header-contents-left">
                <div class="header-left-shortcut">
                    ...
                    <div class="header-username" id="header_username">
                        <p>こんにちは <span id="visitor"></span> さん！</p>
    ...
    <main>
        ...
        <div class="answer-question-target">
        ...
        <div class="answer-question-form">
            <div class="answer-question-form-title">
                <h2>Input form</h2>
                <p>入力フォーム</p>
            </div>
            ...
            <div class="answer-question-warning">
                <p>※投稿内容が警告対象に当てはらないかもう一度確認してから投稿する！ボタンを押してください。<br>
                    警告対象となる行為は<a href="https://jwatch-48c7e.web.app/warning/warning.html" target="_brank" rel="noopener">こちら</a></p>
            </div>
        </div>
...
.answer-question-title h1{
    font-size: 32px;
}

.answer-question-title p{
    font-size: 21px;
    line-height: 2.5em;
}
...
.answer-question-form-title{
    text-align: left;
}

.answer-question-form-title h2{
    font-size: 32px;
}

.answer-question-form-title p{
    font-size: 18px;
}

.answer-question-stadium {
    text-align: center;
}

.answer-question-form h3{
    font-size: 21px;
    font-weight: normal;
}
...
/*スタジアムを選択する*/
.answer-question-stadium h3{
    font-size: 21px;
}

/*カテゴリーを選択する*/
.answer-question-category h3{
    font-size: 21px;
}
...
.answer-question-warning p{
    font-size: 18px;
    text-align: center;
    line-height: 2.0em;
}

.answer-question-warning a{
    text-decoration: none;
    color:rgb(28.8%, 29.6%, 28.8%);
    position: relative;
    display: inline-block;
...
.answer-question-warning a::after{
    position: absolute;
    bottom: 2px;
    left: 0;
    content: '';
...
.answer-question-warning a:hover::after{
    color: gray;
    transform: scale(1, 1);
}
/*以下フッター*/
